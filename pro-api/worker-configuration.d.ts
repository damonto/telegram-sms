/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e4c422b9fad327f76c8f817a7a970290)
// Runtime types generated with workerd@1.20260825.1 2026-08-08 nodejs_compat
interface __BaseEnv_Env {
	sigmo_pro_updates: R2Bucket;
	DB: D1Database;
	BOT_USERNAME: "SigmoProBot";
	SIGMO_TELEGRAM_BOT_TOKEN: string;
	SIGMO_TELEGRAM_WEBHOOK_SECRET: string;
	SIGMO_LICENSE_PRIVATE_KEY: string;
	SIGMO_LICENSE_PUBLIC_KEY: string;
	SIGMO_RELEASE_PUBLIC_KEY: string;
	SIGMO_DOWNLOAD_TICKET_SECRET: string;
	SIGMO_ADMIN_TELEGRAM_IDS: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BOT_USERNAME" | "SIGMO_TELEGRAM_BOT_TOKEN" | "SIGMO_TELEGRAM_WEBHOOK_SECRET" | "SIGMO_LICENSE_PRIVATE_KEY" | "SIGMO_LICENSE_PUBLIC_KEY" | "SIGMO_RELEASE_PUBLIC_KEY" | "SIGMO_DOWNLOAD_TICKET_SECRET" | "SIGMO_ADMIN_TELEGRAM_IDS">> {}
}
